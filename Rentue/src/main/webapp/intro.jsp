	...
	<section id="sidebar">
		<div class="inner">
			<ul class="actions small">
				...
				<li id="displayselect"><input type="button" id="showbtn"
					value="로그인" class="button primary small"></li>
			...
			<div style="display: none;" id="displaydiv">
				...
				<span> <input type="radio" name="member2" value="Rent_member"
					checked>렌탈업체 <input type="radio" name="member2"
					value="Ct_member">관제소
				...
				<div id="container">
					...
					<input type="button" id="hidebtn" value="확인" class="button small"
		...
		<section id="intro" class="wrapper style1 fullscreen fade-up"
			...
			<div id="modal" class="modal-overlay" style="position: absolute;">
				<div class="modal-window">
					<div class="title">
						<div align="center"
							style="float: left; margin-right: 12.5em; margin-left: 2em; margin-top: 1em;">Let's
							Rentue-Member!</div>
					...
					<div class="content">
						<p>
						<div>
							<li><input type="radio" name="member" value="Rent_member"
								checked>렌탈업체 <input type="radio" name="member"
								value="Ct_member">관제소</li>
							...
							<li><input type="text" placeholder="업체명를 입력하세요"
								id="rent_name"></li>
							<li id="r_num"><input type="text" placeholder="사업자번호를 입력하세요"
								id="rent_num"></li>
							<li><input type="text" id="sample5_address"
								placeholder="주소를 검색하세요"> <input type="button"
								onclick="sample5_execDaumPostcode()" value="주소 검색"></li>
							<li id="select"><select id="targetSel">
									<option>소속 관제소 설정</option>
							</select>
								<button id="search">가까운 관제소 찾기</button></li>
							<li><button id="submit" type="button"
									onclick="button_join()">JOIN US</button></li>
							<div id="map"
								style="width: 170px; height: 170px; margin-top: -100px; float: right; display: none"></div>
						</div>
